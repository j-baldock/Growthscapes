...
Plot.plot({
  ...
  marginLeft: 60,
  x: {
    label: "g_warm − g_cold  (g/g/d)",
    tickFormat: d => d.toFixed(2)
  },
  y: {
    label: "P(choose warm patch)",
...
-   `b_interact`: controls steepness of weight buffering on negative growth; smaller values = growth effects persist to larger sizes. Default 0.1 means buffering is near-complete \~50g, i.e., no effect of growth \>50g.
