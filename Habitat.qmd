...
* Habitat network is generalizable and can be expanded to include as many patches as needed.
* Currently, the IBM is not designed to be spatially explicit. May have to shift to Fullerton IBM or HexSim if we want to do that. 
