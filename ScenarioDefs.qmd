...
Read in the look-up table for unfished adult abundance (from the no-harvest simulation runs; table generated in CompareOutcomes.qmd).
```{r}
...
* Habitat availability is fixed throughout the simulation: 95% cold, 5% warm
...
* As above, thermal regimes are offset of each other: warm habitat is 5-10 degrees warmer than the cold habitat. Warm habitat persists overwinter
* Habitat availability is fixed throughout the simulation: 75% cold, 25% warm
...
* As above, thermal regimes are offset of each other: warm habitat is 5-10 degrees warmer than the cold habitat. Warm habitat persists overwinter
* Habitat availability is fixed throughout the simulation: 50% cold, 50% warm
...
* As above, thermal regimes are offset of each other: warm habitat is 5-10 degrees warmer than the cold habitat. Warm habitat persists overwinter
* Habitat availability is fixed throughout the simulation: 25% cold, 75% warm
...
* As above, thermal regimes are offset of each other: warm habitat is 5-10 degrees warmer than the cold habitat. Warm habitat persists overwinter
* Habitat availability is fixed throughout the simulation: 5% cold, 95% warm
...
### Fixed habitat: cold + warm, high P

#### 95% cold / 5% warm

* As above, thermal regimes are offset of each other: warm habitat is 5-10 degrees warmer than the cold habitat. Warm habitat persists overwinter
* Habitat availability is fixed throughout the simulation: 95% cold, 5% warm
* Maximum P_cmax is 10% greater in warm (0.6) relative to cold (0.5)
